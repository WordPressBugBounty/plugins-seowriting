...
Fix:
* Remove images when republishing a post

= 1.10.8 (2025/03/26) =

Feature:
* Default file name for image without alt
...
Feature:
* Post images are loaded from any source
...
Feature:
* Updating a post instead of republishing
